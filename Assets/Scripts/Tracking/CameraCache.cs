...
// Note: This is taken from the Mixed Reality Toolkit to provide this functionality without relying on the toolkit.
        ...
        public static Camera Main
        {
            get
            {
                ...
                if (mainCamera == null)
                {
                    ...
                    {
                        Debug.LogWarning("Unable to determine a main camera. Please tag the scene's primary camera as \"MainCamera\", in the hierarchy.");
                    }
                }
