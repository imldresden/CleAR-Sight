        ...
        SubShader
        {
            ...
            Cull Off
                ...
                CGPROGRAM
                 ...
                 //   #pragma multi_compile __ _ISSLICING_ON
            ...
            sampler2D _MainTex;
            float4 _Plane;
            //float _isSlicing = _ISSLICING_ON;
             ...
             void GS_Main(point GS_INPUT p[1], inout TriangleStream<g2f> triStream)
             {
                 // if(_isSlicing){
//#ifdef _ISSLICING_ON
                float distance = dot(mul(unity_ObjectToWorld, p[0].vertex), _Plane.xyz);
