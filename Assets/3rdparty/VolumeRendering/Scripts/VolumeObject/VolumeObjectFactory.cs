...
namespace UnityVolumeRendering
{
    ...
    {
        public static VolumeRenderedObject CreateObject(VolumeDataset dataset, GameObject parent = null)
        {
            GameObject outerObject;
            if (parent == null)
            {
                outerObject = new GameObject("VolumeRenderedObject_" + dataset.datasetName);
            }
            else
            {
                outerObject = parent;
